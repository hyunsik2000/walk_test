...
import 'package:project123/UI/screens/profile/header.dart';
import 'package:project123/loginuser/userInfo.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  get datas => <ProfileOption>[
        ProfileOption.arrow(title: '프로필 정보', icon: _profileIcon('user@2x.png'),
